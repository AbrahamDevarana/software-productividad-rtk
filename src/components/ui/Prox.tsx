...
export const Prox = ({avance, size = 'default', text = 'Estamos preparando esta sección, para que pronto esté disponible para ti.' }: Props) => {
	...
	return (
		<div className='max-w-lg m-auto text-center w-full'>
			...
			<p className='text-devarana-dark-graph'> {text}  </p>
			<div className='py-5'>
