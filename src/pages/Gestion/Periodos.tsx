...
import { useGetGestionPeriodosQuery, useUpdateGestionPeriodosMutation } from '@/redux/features/gestion/gestionThunk'
...
export const Periodos = () => {
    ...
    const { isLoading, isFetching, isSuccess , data: gestionObjetivo } = useGetGestionPeriodosQuery({quarter, year})
    const [updateGestionObjetivos, {isLoading: isUpdating}] = useUpdateGestionPeriodosMutation()
